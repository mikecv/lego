...
def parseset(self, jlogger, set_id, my_set):
    ...
    # Have a set to save to database.
    haveSetToSave = True
                ...
                if reg_match:
                    ...
                    if reg_match:
                        ...
                        for part_match in re.finditer(reg_string, setdata, re.DOTALL):
                            ...
                            if pc_Complete > 90:
                                pc_Complete = 90
                            pr.set_progress(pc_Complete, 100, description="Processing part: {0}".format(part_qty_chk))
                            logger.debug('Progress percentage: {0:d}'.format(pc_Complete))
                            ...
                            if haveSetToSave:
                                ...
                                # In which case we want to add the part as one of my parts, i.e. held by me.
                                if my_set == True:
                        ...
                        # If we have a set full of parts to add, then add the set.
                        if haveSetToSave:
